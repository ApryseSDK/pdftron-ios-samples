...
TRN_API TRN_PDFViewHasChangesSinceSnapshot(TRN_PDFView view, TRN_Bool* result);
...
TRN_API TRN_PDFViewCanUndo(TRN_PDFView view, TRN_Bool* result);
TRN_API TRN_PDFViewCanRedo(TRN_PDFView view, TRN_Bool* result);
TRN_API TRN_PDFViewRevertChangesSinceSnapshot(TRN_PDFView view);
...
TRN_API TRN_PDFViewSetFieldHighlightColor(TRN_PDFView view,  const TRN_ColorPt* col);
...
TRN_API TRN_PDFViewSetSignatureHighlightColor(TRN_PDFView view,  const TRN_ColorPt* col);
...
TRN_API TRN_PDFViewGetRightToLeftLanguage(TRN_PDFView view, TRN_Bool* result);
TRN_API TRN_PDFViewSetPageBox(TRN_PDFView view, enum TRN_PageBox region);
TRN_API TRN_PDFViewGetPageBox(const TRN_PDFView view, enum TRN_PageBox* result);
...
TRN_API TRN_PDFViewGetPostProcessedColor (TRN_PDFView view, const TRN_ColorPt* col, TRN_ColorPt* result);
...
TRN_API TRN_PDFViewGetTextSelectionMode(TRN_PDFView view, enum TRN_PDFViewTextSelectionMode* result);
