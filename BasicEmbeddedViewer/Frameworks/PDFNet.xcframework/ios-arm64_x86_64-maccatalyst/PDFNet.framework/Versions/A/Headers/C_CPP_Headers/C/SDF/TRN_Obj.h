...
TRN_API TRN_ObjIsEqualValue(TRN_Obj o, TRN_Obj to, TRN_Bool* result);
...
TRN_API TRN_ObjSetStreamData( TRN_Obj obj, const char* data_buf, const size_t data_buf_size );
TRN_API TRN_ObjSetStreamDataWithFilter(TRN_Obj obj, const char* data_buf, const size_t data_buf_size, TRN_Filter no_own_filter_chain);
