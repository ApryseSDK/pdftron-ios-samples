...
public:
	 ...
	 * be added as a foreground or background layer to the existing page or to replace the content of the page.
	 * By default, the new content will appear on top of the existing graphics. 
	 * 
