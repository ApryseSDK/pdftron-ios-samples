...
TRN_API TRN_AnnotSetUniqueID(TRN_Annot annot, const char* id_buf, int id_buf_size);
...
TRN_API TRN_FreeTextAnnotSetFontName(TRN_FreeTextAnnot ft, const char* fontName);
...
TRN_API TRN_InkAnnotGetPointCount(TRN_InkAnnot ink, unsigned int pathindex, int* result);
...
TRN_API TRN_RedactionAnnotSetOverlayTextFont(TRN_RedactionAnnot redaction, TRN_UString font_name);
TRN_API TRN_RedactionAnnotSetOverlayTextFontSize(TRN_RedactionAnnot redaction, double font_size);
...
TRN_API TRN_RubberStampAnnotSetOpacity(TRN_Annot stamp, double opacity);
...
TRN_API TRN_TextAnnotGetAnchorPosition(TRN_TextAnnot text, TRN_Point* anchor);
TRN_API TRN_TextAnnotSetAnchorPosition(TRN_TextAnnot text, const TRN_Point* anchor);
