...
inline void PDFDraw::SetDrawUIElements(bool draw_ui_elements)
{
	REX(TRN_PDFDrawSetDrawUIElements(mp_draw,BToTB(draw_ui_elements)));
}
...
inline void PDFDraw::SetThinLineScaling(double scaling)
{
	REX(TRN_PDFDrawSetThinLineScaling(mp_draw, scaling));
}
