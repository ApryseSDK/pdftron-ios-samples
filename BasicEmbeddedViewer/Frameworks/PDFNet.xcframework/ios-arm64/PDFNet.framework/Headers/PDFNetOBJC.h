...
@class PTAppearance;
@class PTCheckBoxWidget;
@class PTComboBoxWidget;
@class PTListBoxWidget;
@class PTPushButtonWidget;
@class PTRadioButtonWidget;
@class PTRadioButtonGroup;
@class PTSignatureWidget;
@class PTViewerOptimizedOptions;
@class PTDisallowedChange;
@class PTObjectIdentifier;
@class PTTrustVerificationResult;
@class PTPTEmbeddedTimestampVerificationResult;
@class PTEmbeddedTimestampVerificationResult;
@class PTWordOutputOptions;
@class PTPowerPointOutputOptions;
@class PTExcelOutputOptions;
@class PTPDFUAOptions;
@class PTFlowDocument;
@class PTContentNode;
@class PTContentNodeIterator;
@class PTContentElement;
@class PTParagraph;
@class PTTextRun;
@class PTTable;
@class PTTableRow;
...
@class PTList;
@class PTListItem;
@class PTTextStyledElement;
@class PTContentNodeRef;
@class PTParagraphRef;
@class PTTextRunRef;
@class PTTableRef;
@class PTTableRowRef;
@class PTTableCellRef;
@class PTListRef;
@class PTListItemRef;
typedef size_t SignatureHandlerId;
typedef SignatureHandlerId PTSignatureHandlerId;

typedef enum PTResultState {  e_ptrs_failure,
  e_ptrs_success,
  ...
  e_ptrs_fetch,
  e_ptrs_render,
  e_ptrs_postponed}PTResultState;
...
typedef enum PTParaTextJustification {  e_ptpara_text_justification_invalid = 0,
  e_ptpara_text_justify_left = 1,
  e_ptpara_text_justify_right = 2,
  e_ptpara_text_justify_center = 3}PTParaTextJustification;

typedef enum PTCellAlignmentVertical {  e_ptcell_alignment_top = 1,
  e_ptcell_alignment_center = 2,
  e_ptcell_alignment_bottom = 3}PTCellAlignmentVertical;

typedef enum PTCellAlignmentHorizontal {  e_ptcell_alignment_left = 1,
  e_ptcell_alignment_middle = 2,
  e_ptcell_alignment_right = 3}PTCellAlignmentHorizontal;

typedef enum PTListNumberFormat {  e_ptlist_format_none = 0,
  e_ptlist_format_decimal,
  e_ptlist_format_lower_roman,
  e_ptlist_format_upper_roman,
  e_ptlist_format_lower_letter,
  e_ptlist_format_upper_letter,
  e_ptlist_format_ordinal,
  e_ptlist_format_ordinal_text,
  e_ptlist_format_chinese_counting,
  e_ptlist_format_chinese_counting_thousand,
  e_ptlist_format_cardinal_text,
  e_ptlist_format_decimal_zero}PTListNumberFormat;
...
typedef enum PTCADLayoutSortOrder {  e_pt_default_order = 0,
  e_pt_alphabetic_order = 1,
  e_pt_alphanumeric_order = 2}PTCADLayoutSortOrder;

typedef enum BarcodeTypeGroup {  e_ptbarcode_none = 0,
  e_linear = 1,
  e_ptbarcode_post_net_planet = 2,
  e_ptbarcode_four_state = 4,
  e_ptbarcode_gs1_databar_stacked = 8,
  e_ptbarcode_qr = 16,
  e_ptbarcode_data_matrix = 32,
  e_ptbarcode_aztec = 64,
  e_ptbarcode_maxi = 128,
  e_ptbarcode_micro_qr = 256,
  e_ptbarcode_pdf417 = 512,
  e_ptbarcode_micro_pdf417 = 1024,
  e_ptbarcode_patch_code = 2048,
  e_ptbarcode_pharma_code = 4096}BarcodeTypeGroup;

typedef enum BarcodeOrientation {  e_ptbarcode_horizontal = 1,
  e_ptbarcode_vertical = 2,
  e_ptbarcode_diagonal = 4}BarcodeOrientation;

typedef enum BarcodeProfile {  e_ptbarcode_high_quality_source_profile = 1,
  e_ptbarcode_low_quality_source_profile = 2,
  e_ptbarcode_small_barcodes_profile = 3,
  e_ptbarcode_natural_picture_profile = 4}BarcodeProfile;

typedef enum OutputFormat {  e_auto = 0,
  e_binary = 1}OutputFormat;
...
typedef enum PTErrorCode {  e_ptPDFA0_1_0 = 10,
  ...
  e_ptPDFA1_12_6 = 1126,
  e_ptPDFA1_12_7 = 1127,
  e_ptPDFA1_12_11 = 11211,
  e_ptPDFA1_12_13 = 11213,
  e_ptPDFA1_12_15 = 11215,
  e_ptPDFA1_13_1 = 1131,
  e_ptPDFA2_2_1 = 221,
  e_ptPDFA2_3_2 = 232,
  e_ptPDFA2_3_3 = 233,
  ...
  e_ptPDFA1_12_12 = 11212,
  e_ptPDFA1_12_14 = 11214,
  e_ptPDFA1_13_5 = 1135,
  e_ptPDFA2_3_10 = 2310,
  e_ptPDFA2_4_2_10 = 24210,
  e_ptPDFA2_4_2_11 = 24211,
  e_ptPDFA2_4_2_12 = 24212,
  e_ptPDFA2_4_2_13 = 24213,
  e_ptPDFA2_5_10 = 2510,
  e_ptPDFA2_5_11 = 2511,
  e_ptPDFA2_5_12 = 2512,
  ...
  e_ptPDFA_3E2 = 2,
  e_ptPDFA_3E3 = 3,
  e_ptPDFA_4_6_1_3_4 = 46134,
  e_ptPDFA_4_6_1_3_5 = 46135,
  e_ptPDFA_4_6_1_6_1_3 = 461613,
  e_ptPDFA_4_6_7_3_5 = 46735,
  e_ptPDFA_4_6_2_5_3 = 46253,
  e_ptPDFA_4_6_6_3_1 = 46631,
  e_ptPDFA_4_6_1_12_1 = 461121,
  e_ptPDFA_4_6_2_4_2_3 = 462423,
  e_ptPDFA_4_6_2_2_3 = 46223,
  e_ptPDFA_4_6_3_1_6 = 46316,
  e_ptPDFA_4_6_9_5 = 4695,
  e_ptPDFA_4_6_2_10_6_1 = 4621061,
  e_ptPDFA_4_6_2_10_6_4 = 4621064,
  e_ptPDFA_4_6_2_10_8_1 = 4621081,
  e_ptPDFA_LAST}PTErrorCode;

typedef enum PTPDFUAConformanceLevel {  e_ptUA_Level1 = 0}PTPDFUAConformanceLevel;
...
typedef enum PTOfficeToPDFStructureTagLevel {  e_ptoffice_structure_tag_level_default = 0,
  e_ptoffice_structure_tag_level_none = 1}PTOfficeToPDFStructureTagLevel;

typedef enum PTOfficeToPDFDisplayComments {  e_ptoffice_display_comments_off = 0,
  e_ptoffice_display_comments_annotations = 1}PTOfficeToPDFDisplayComments;

typedef enum DisplaySpeakerNotes {  e_no_speaker_notes = 0,
  e_speaker_notes_annotations = 1}DisplaySpeakerNotes;

typedef enum UpdateDynamicFields {  e_update_all = -1,
  e_update_none = 0,
  e_update_doc_props = 1}UpdateDynamicFields;

typedef enum AnimationMode {  e_ignore = 0,
  e_paginate = 1}AnimationMode;

typedef enum PTDocumentConversionResult {  e_ptSuccess = 0,
  e_ptIncomplete = 1,
  e_ptFailure = 2}PTDocumentConversionResult;

typedef enum PTTemplateDocumentResult {  e_ptTemplateFillSuccess = 0,
  e_ptTemplateFillIncomplete = 1,
  e_ptTemplateFillFailure = 2}PTTemplateDocumentResult;
...
typedef enum PTLanguageChoice {  e_ptlang_auto = 0,
  e_ptlang_catalan,
  e_ptlang_danish,
  e_ptlang_german,
  e_ptlang_english,
  ...
  e_ptlang_slovenian,
  e_ptlang_swedish,
  e_ptlang_turkish}PTLanguageChoice;

typedef enum PTPreferredOCREngine {  e_pt_ocr_engine_default = 0,
  e_pt_ocr_engine_tesseract}PTPreferredOCREngine;

typedef enum PTSectionConversionSetting {  e_ptrecover = 0,
  e_ptdonotdetect,
  e_ptdetectandremove}PTSectionConversionSetting;

typedef enum PTHTMLContentReflowSetting {  e_pthtml_fixed_position = 0,
  e_pthtml_reflow_paragraphs,
  e_pthtml_reflow_full}PTHTMLContentReflowSetting;

typedef enum PTHTMLSearchableImageSetting {  e_pthtml_ocr_image_text = 0,
  e_pthtml_ocr_image,
  e_pthtml_ocr_text,
  e_pthtml_ocr_off,
  e_pthtml_ocr_always}PTHTMLSearchableImageSetting;

typedef enum PTWordOutputFormat {  e_ptwof_docx = 0,
  e_ptwof_doc,
  e_ptwof_rtf,
  e_ptwof_txt}PTWordOutputFormat;

typedef enum PTWordSearchableImageSetting {  e_ptword_ocr_image_text = 0,
  e_ptword_ocr_image,
  e_ptword_ocr_text,
  e_ptword_ocr_off,
  e_ptword_ocr_always}PTWordSearchableImageSetting;

typedef enum PTExcelSearchableImageSetting {  e_ptexcel_ocr_text = 2,
  e_ptexcel_ocr_off,
  e_ptexcel_ocr_always}PTExcelSearchableImageSetting;

typedef enum PTPowerPointSearchableImageSetting {  e_ptpowerpoint_ocr_text = 2,
  e_ptpowerpoint_ocr_off,
  e_ptpowerpoint_ocr_always}PTPowerPointSearchableImageSetting;

typedef enum PTDataExtractionEngine {  e_ptextract_tabular = 0,
  e_ptextract_form = 1,
  e_ptextract_doc_structure = 2,
  e_ptextract_form_key_value = 3,
  e_ptextract_generic_key_value = 4,
  e_ptextract_doc_classification = 5}PTDataExtractionEngine;

typedef enum PTXLIFFVersion {  e_ptxliff_version_1 = 1,
  e_ptxliff_version_2 = 2}PTXLIFFVersion;

typedef enum HorizAlignment {  e_left = 1,
  e_center = 2,
  e_right = 3,
  e_full = 4}HorizAlignment;

typedef enum ReflowType {  e_text = 1,
  e_line = 2,
  e_para = 3}ReflowType;

typedef enum MatchType {  e_exact = 1,
  e_wildcards = 2,
  e_regex = 3}MatchType;
...
typedef enum PTConnectionErrorHandlingMode {  e_ptcontinue,
  e_ptcontinue_unless_switching_to_demo,
  e_ptstop}PTConnectionErrorHandlingMode;
...
typedef enum PTAnnotBitmapFlags {  e_ptnormal_annot_bitmap = 1,
  ...
  e_ptannot_renders_complete = 131}PTAnnotBitmapFlags;

typedef enum PTAnnotVectorMode {  e_ptno_vector_annots,
  e_ptpdftron_vector_annots}PTAnnotVectorMode;
...
typedef enum PTProcessingFlags {  e_ptno_ligature_exp = 1,
  ...
  e_ptextract_using_zorder = 256}PTProcessingFlags;
...
typedef enum PTTextSearchModes {  e_ptreg_expression = 0x0001,
  ...
  e_ptsearch_using_zorder = e_ptraw_text_search << 1}PTTextSearchModes;
...
- (instancetype)initWithA: (double)a b:  (double)b c:  (double)c d:  (double)d h:  (double)h v:  (double)v;
@end
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (instancetype)initWithInput_filter: (PTFilter*)input_filter line_width:  (int)line_width buf_sz:  (unsigned long)buf_sz;
@end
...
- (void)Flush;
- (void)FlushAll;
- (instancetype)init;- (instancetype)initWithFilter: (PTFilter*)filter;
@end
...
- (instancetype)init;- (instancetype)initWithFilepath: (NSString *)filepath;- (instancetype)initWithStream: (PTFilter*)stream;- (instancetype)initWithBuf: (NSData*)buf buf_size:  (unsigned long)buf_size;
@end
...
- (instancetype)initWithCrypt_type: (PTAlgorithmType)crypt_type;- (instancetype)initWithName: (NSString *)name key_len:  (int)key_len enc_code:  (int)enc_code;- (instancetype)init;
@end
...
@interface PTFlowDocument : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (PTParagraph*)AddParagraph;
- (PTParagraph*)AddParagraphWithText: (NSString *)text;
- (PTList*)AddList;
- (PTTable*)AddTable;
- (void)SetDefaultMargins: (double)left top:  (double)top right:  (double)right bottom:  (double)bottom;
- (void)SetDefaultPageSize: (double)width height:  (double)height;
- (PTContentNode*)GetBody;
- (PTPDFDoc*)PaginateToPDF;
- (instancetype)init;
@end


@interface PTTextStyledElement : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (void)SetFontFace: (NSString *)font_name;
...
- (BOOL)IsBold;
- (void)SetTextColor: (unsigned char)red green:  (unsigned char)green blue:  (unsigned char)blue;
- (void)SetBackgroundColor: (unsigned char)red green:  (unsigned char)green blue:  (unsigned char)blue;

@end


@interface PTContentElement : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)Destroy;
- (PTList*)AsList;
- (PTListItem*)AsListItem;
- (PTContentNode*)AsContentNode;
- (PTTextRun*)AsTextRun;
- (PTParagraph*)AsParagraph;
- (PTTable*)AsTable;
- (PTTableRow*)AsTableRow;
- (PTTableCell*)AsTableCell;
- (PTTextStyledElement*)GetTextStyledElement;

@end


@interface PTTextRun : PTContentElement
- (void*)getCptr;
- (instancetype)initWithCptr: (void*) cptr;
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
...
@interface PTContentNode : PTContentElement
- (void*)getCptr;
- (instancetype)initWithCptr: (void*) cptr;
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (void)Destroy;
- (PTContentNodeIterator*)GetContentNodeIterator;

@end


@interface PTParagraph : PTContentNode
- (void*)getCptr;
- (instancetype)initWithCptr: (void*) cptr;
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (void)Destroy;
- (PTTextRun*)AddText: (NSString *)text;
- (void)SetSpaceBefore: (double)val;
- (double)GetSpaceBefore;
- (void)SetSpaceAfter: (double)val;
- (double)GetSpaceAfter;
- (void)SetJustificationMode: (PTParaTextJustification)val;
- (PTParaTextJustification)GetJustificationMode;
...
- (void)SetBorder: (double)thickness red:  (unsigned char)red green:  (unsigned char)green blue:  (unsigned char)blue;
...
- (void)SetSpacesPerTab: (unsigned int)val;
- (unsigned int)GetSpacesPerTab;
...
@interface PTTableCell : PTContentNode
- (void*)getCptr;
- (instancetype)initWithCptr: (void*) cptr;
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
...
- (PTParagraph*)AddParagraphWithText: (NSString *)text;
- (PTTable*)AddTable;
- (PTTableCell*)MergeCellsRight: (unsigned int)num;
- (PTTableCell*)MergeCellsDown: (unsigned int)num;
- (void)SetBackgroundColor: (unsigned char)red green:  (unsigned char)green blue:  (unsigned char)blue;
- (void)SetBorder: (double)thickness red:  (unsigned char)red green:  (unsigned char)green blue:  (unsigned char)blue;
- (double)GetBorderThickness;
- (void)SetVerticalAlignment: (PTCellAlignmentVertical)val;
- (PTCellAlignmentVertical)GetVerticalAlignment;
- (void)SetHorizontalAlignment: (PTCellAlignmentHorizontal)val;
- (PTCellAlignmentHorizontal)GetHorizontalAlignment;
...
@interface PTTableRow : PTContentNode
- (void*)getCptr;
- (instancetype)initWithCptr: (void*) cptr;
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (void)Destroy;
- (PTTableCell*)AddTableCell;
...
@interface PTTable : PTContentNode
- (void*)getCptr;
- (instancetype)initWithCptr: (void*) cptr;
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (void)Destroy;
- (PTTableRow*)AddTableRow;
- (PTTableCell*)GetTableCell: (unsigned int)column row:  (unsigned int)row;
...
@interface PTList : PTContentNode
- (void*)getCptr;
- (instancetype)initWithCptr: (void*) cptr;
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (void)SetNumberFormat: (PTListNumberFormat)format;
- (void)SetNumberFormatWithSuffix: (PTListNumberFormat)format suffix:  (NSString *)suffix cascade:  (BOOL)cascade;
- (PTTextStyledElement*)GetLabelStyle;
...
@interface PTListItem : PTContentNode
- (void*)getCptr;
- (instancetype)initWithCptr: (void*) cptr;
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
...
@interface PTContentNodeIterator : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)Destroy;
- (void)Next;
- (PTContentElement*)Current;
- (BOOL)HasNext;
- (instancetype)init;
@end


@interface PTContentNodeRef : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (PTContentNode*)GetElement;
- (BOOL)IsValid;
- (PTContentNode*)__deref__;
- (PTContentNode*)__ref__;
- (void)Destroy;
- (PTContentNodeIterator*)GetContentNodeIterator;
- (PTList*)AsList;
- (PTListItem*)AsListItem;
...
@interface PTParagraphRef : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (PTParagraph*)GetElement;
- (BOOL)IsValid;
- (PTParagraph*)__deref__;
- (PTParagraph*)__ref__;
- (void)Destroy;
- (PTTextRun*)AddText: (NSString *)text;
- (void)SetSpaceBefore: (double)val;
...
@interface PTTextRunRef : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
@interface PTTableRowRef : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (PTTableRow*)GetElement;
- (BOOL)IsValid;
- (PTTableRow*)__deref__;
- (PTTableRow*)__ref__;
- (void)Destroy;
- (PTTableCell*)AddTableCell;
- (void)SetRowHeight: (double)val;
...
@interface PTTableCellRef : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (PTTableCell*)GetElement;
- (BOOL)IsValid;
- (PTTableCell*)__deref__;
- (PTTableCell*)__ref__;
- (void)Destroy;
- (PTParagraph*)AddParagraph;
- (PTParagraph*)AddParagraphWithText: (NSString *)text;
...
@interface PTListItemRef : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (PTListItem*)GetElement;
- (BOOL)IsValid;
- (PTListItem*)__deref__;
- (PTListItem*)__ref__;
- (PTParagraph*)AddParagraph;
- (PTParagraph*)AddParagraphWithText: (NSString *)text;
- (PTList*)AddList;
...
- (unsigned long long)GetHandleInternal;
- (instancetype)init;- (instancetype)initWithOther: (PTGeometryCollection*)other;
@end
...
- (void)AnnotInsertWithTagging: (unsigned int)pos annot:  (PTAnnot*)annot tag_parent:  (PTObj*)tag_parent options:  (SWIGTYPE_p_pdftron__PDF__TaggingOptions*)options;
...
- (instancetype)init;- (instancetype)initWithD: (PTObj*)d;- (instancetype)initWithYear: (unsigned short)year month:  (char)month day:  (char)day hour:  (char)hour minute:  (char)minute second:  (char)second;
@end
...
+ (PTImage*)CreateImageMaskWithBuffer: (PTSDFDoc*)doc buf:  (NSData *)buf buf_size:  (unsigned long)buf_size width:  (int)width height:  (int)height encoder_hints:  (PTObj*)encoder_hints;
+ (PTImage*)CreateImageMask: (PTSDFDoc*)doc buf:  (NSData *)buf buf_size:  (unsigned long)buf_size width:  (int)width height:  (int)height;
...
+ (PTImage*)CreateSoftMaskWithBuffer: (PTSDFDoc*)doc buf:  (NSData *)buf buf_size:  (unsigned long)buf_size width:  (int)width height:  (int)height bpc:  (int)bpc encoder_hints:  (PTObj*)encoder_hints;
+ (PTImage*)CreateSoftMask: (PTSDFDoc*)doc buf:  (NSData *)buf buf_size:  (unsigned long)buf_size width:  (int)width height:  (int)height bpc:  (int)bpc;
...
- (instancetype)initWithIn_oid_enum: (PTPredefined)in_oid_enum;- (instancetype)initWithIn_digest_algorithm_type: (PTDigestAlgorithmType)in_digest_algorithm_type;
@end


@interface PTAlgorithmParams : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
@interface PTAlgorithmIdentifier : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (instancetype)initWithOid_type: (PTPredefined)oid_type;- (instancetype)initWithOid: (PTObjectIdentifier*)oid;- (instancetype)initWithDigest_algorithm_type: (PTDigestAlgorithmType)digest_algorithm_type;- (instancetype)initWithOid_type: (PTPredefined)oid_type params:  (PTAlgorithmParams*)params;- (instancetype)initWithOid: (PTObjectIdentifier*)oid params:  (PTAlgorithmParams*)params;- (instancetype)initWithDigest_algorithm_type: (PTDigestAlgorithmType)digest_algorithm_type params:  (PTAlgorithmParams*)params;
@end


@interface PTRSASSAPSSParams : PTAlgorithmParams
- (void*)getCptr;
- (instancetype)initWithCptr: (void*) cptr;
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (PTAlgorithmIdentifier*)GetDigestAlgorithm;
- (void)SetDigestAlgorithm: (PTAlgorithmIdentifier*)value;
- (PTAlgorithmIdentifier*)GetMaskGenAlgorithm;
- (void)SetMaskGenAlgorithm: (PTAlgorithmIdentifier*)value;
- (unsigned int)GetSaltLength;
- (void)SetSaltLength: (unsigned int)value;
- (unsigned int)GetTrailerField;
- (void)SetTrailerField: (unsigned int)value;
- (instancetype)initWithImpl: (void *)impl;- (instancetype)initWithDigest_algorithm_id: (PTAlgorithmIdentifier*)digest_algorithm_id salt_length:  (unsigned int)salt_length;
@end
...
- (NSData*)GetData;
- (instancetype)initWithIn_certificate_path: (NSString *)in_certificate_path;- (instancetype)initWithIn_cert_buf: (NSData*)in_cert_buf;
@end
...
- (instancetype)initWithField_dict: (PTObj*)field_dict fdf_dict:  (PTObj*)fdf_dict;
@end
...
- (instancetype)init;- (instancetype)initWithSdfdoc: (PTSDFDoc*)sdfdoc;- (instancetype)initWithFilepath: (NSString *)filepath;- (instancetype)initWithStream: (PTFilter*)stream;
@end
...
- (instancetype)initWithImpl: (void *)impl;- (instancetype)initWithLevel: (PTVerificationOptionsSecurityLevel)level;
@end
...
- (instancetype)initWithIn_url: (NSString *)in_url;- (instancetype)init;
@end
...
@interface PTCMSSignatureOptions : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (void)AddTimestampToken: (NSData*)token_buf;
- (instancetype)init;
@end
...
- (PTTimestampingResult*)GenerateContentsWithEmbeddedTimestamp: (PTTimestampingConfiguration*)in_timestamping_config in_timestamp_response_verification_options:  (PTVerificationOptions*)in_timestamp_response_verification_options;
- (void)UseSubFilter: (PTDigitalSignatureFieldSubFilterType)in_subfilter_type in_make_mandatory:  (BOOL)in_make_mandatory;
- (NSData*)CalculateDigest: (PTDigestAlgorithmType)in_digest_algorithm_type;
- (void)SetPreferredDigestAlgorithm: (PTDigestAlgorithmType)in_digest_algorithm_type in_make_mandatory:  (BOOL)in_make_mandatory;
- (void)CreateSigDictForCustomCertification: (NSString *)in_filter_name in_subfilter_type:  (PTDigitalSignatureFieldSubFilterType)in_subfilter_type in_contents_size_to_reserve:  (unsigned int)in_contents_size_to_reserve;
- (void)CreateSigDictForCustomSigning: (NSString *)in_filter_name in_subfilter_type:  (PTDigitalSignatureFieldSubFilterType)in_subfilter_type in_contents_size_to_reserve:  (unsigned int)in_contents_size_to_reserve;
- (void)SetSigDictTimeOfSigning: (PTDate*)in_date;
+ (NSData*)SignDigest: (NSData*)in_digest in_pkcs12_keyfile_path:  (NSString *)in_pkcs12_keyfile_path in_keyfile_password:  (NSString *)in_keyfile_password in_pades_mode:  (BOOL)in_pades_mode in_digest_algorithm_type:  (PTDigestAlgorithmType)in_digest_algorithm_type;
+ (NSData*)SignDigestWithBuffer: (NSData*)in_digest in_pkcs12_buffer:  (NSData*)in_pkcs12_buffer in_keyfile_password:  (NSString *)in_keyfile_password in_pades_mode:  (BOOL)in_pades_mode in_digest_algorithm_type:  (PTDigestAlgorithmType)in_digest_algorithm_type;
+ (NSData*)GenerateESSSigningCertPAdESAttribute: (PTX509Certificate*)in_signer_cert in_digest_algorithm_type:  (PTDigestAlgorithmType)in_digest_algorithm_type;
+ (NSData*)GenerateCMSSignedAttributes: (NSData*)in_digest_buf in_custom_signedattributes_buf:  (NSData*)in_custom_signedattributes_buf;
+ (NSData*)GenerateCMSSignature: (PTX509Certificate*)in_signer_cert in_chain_certs_list:  (NSArray<PTX509Certificate *> *)in_chain_certs_list in_digest_algorithm_oid:  (PTObjectIdentifier*)in_digest_algorithm_oid in_signature_algorithm_oid:  (PTObjectIdentifier*)in_signature_algorithm_oid in_signature_value_buf:  (NSData*)in_signature_value_buf in_signedattributes_buf:  (NSData*)in_signedattributes_buf;
+ (NSData*)GenerateCMSSignatureWithAlgoId: (PTX509Certificate*)signer_cert chain_certs_list:  (NSArray<PTX509Certificate *> *)chain_certs_list digest_algorithm_id:  (PTAlgorithmIdentifier*)digest_algorithm_id signature_algorithm_id:  (PTAlgorithmIdentifier*)signature_algorithm_id signature_value_buf:  (NSData*)signature_value_buf signedattributes_buf:  (NSData*)signedattributes_buf cms_options:  (PTCMSSignatureOptions*)cms_options;
+ (BOOL)SetDigSigLogFilename: (NSString *)filename;
...
- (PTObj*)GetSDFObj;
- (instancetype)initWithF: (PTObj*)f;
@end
...
- (instancetype)initWithS: (PTBdStyle)s b_width:  (double)b_width b_hr:  (double)b_hr b_vr:  (double)b_vr;- (instancetype)initWithS: (PTBdStyle)s b_width:  (double)b_width b_hr:  (double)b_hr b_vr:  (double)b_vr b_dash:  (NSMutableArray*)b_dash;
@end
...
- (instancetype)initWithD: (PTObj*)d;- (instancetype)init;- (instancetype)initWithAnn: (PTAnnot*)ann;
@end
...
- (instancetype)initWithD: (PTObj*)d;- (instancetype)initWithAnn: (PTAnnot*)ann;
@end
...
+ (PTInk*)CreateAnnot: (PTSDFDoc*)doc pos:  (PTPDFRect*)pos;
- (int)GetPathCount;
...
- (PTDiffOptions*)SetLuminosityCompression: (double)value;
- (instancetype)init;
@end
...
+ (PTAction*)CreateHideField: (PTSDFDoc*)sdfdoc field:  (NSArray<NSString *> *)field;
...
- (unsigned long long)GetHandleInternal;
- (instancetype)initWithAction: (PTAction*)action field:  (PTField*)field;- (instancetype)initWithAction: (PTAction*)action annot:  (PTAnnot*)annot;- (instancetype)initWithAction: (PTAction*)action;
@end
...
- (PTOCROptions*)SetIncludeExistingText: (BOOL)value;
...
- (PTCADConvertOptions*)SetIncludeInvisibleLayers: (BOOL)value;
- (BOOL)GetIncludeModel;
- (PTCADConvertOptions*)SetIncludeModel: (BOOL)value;
- (BOOL)GetIncludeNonPlottableLayers;
- (PTCADConvertOptions*)SetIncludeNonPlottableLayers: (BOOL)value;
...
- (PTCADConvertOptions*)SetUnderlineTextDataFields: (BOOL)value;
...
- (BOOL)GetDetectEmptyFields;
- (PTDataExtractionOptions*)SetDetectEmptyFields: (BOOL)value;
- (PTDataExtractionOptions*)AddExclusionZonesForPage: (PTPDFRectCollection*)value page_num:  (int)page_num;
- (NSString *)GetFormExtractionEngine;
- (PTDataExtractionOptions*)SetFormExtractionEngine: (NSString *)value;
- (PTDataExtractionOptions*)AddInclusionZonesForPage: (PTPDFRectCollection*)value page_num:  (int)page_num;
- (NSString *)GetLanguage;
- (PTDataExtractionOptions*)SetLanguage: (NSString *)value;
- (double)GetMinimumConfidenceThreshold;
- (PTDataExtractionOptions*)SetMinimumConfidenceThreshold: (double)value;
...
- (BOOL)GetTextRecoveryNSE;
- (PTDataExtractionOptions*)SetTextRecoveryNSE: (BOOL)value;
- (instancetype)init;
@end


@interface PTBarcodeOptions : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (unsigned int)GetBarcodeOrientations;
- (PTBarcodeOptions*)SetBarcodeOrientations: (unsigned int)value;
- (BarcodeProfile)GetBarcodeProfile;
- (PTBarcodeOptions*)SetBarcodeProfile: (BarcodeProfile)value;
- (unsigned int)GetBarcodeSearchTypes;
- (PTBarcodeOptions*)SetBarcodeSearchTypes: (unsigned int)value;
- (OutputFormat)GetDataOutputFormat;
- (PTBarcodeOptions*)SetDataOutputFormat: (OutputFormat)value;
- (NSString *)GetPages;
- (PTBarcodeOptions*)SetPages: (NSString *)value;
- (instancetype)init;
@end


@interface PTHandwritingICROptions : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (PTHandwritingICROptions*)AddIgnoreZonesForPage: (PTPDFRectCollection*)value page_num:  (int)page_num;
- (PTHandwritingICROptions*)AddInclusionZonesForPage: (PTPDFRectCollection*)value page_num:  (int)page_num;
- (NSString *)GetPages;
- (PTHandwritingICROptions*)SetPages: (NSString *)value;
- (instancetype)init;
@end
...
- (instancetype)initWithD: (PTObj*)d;- (instancetype)init;- (instancetype)initWithCircle: (PTAnnot*)circle;
@end
...
+ (PTFreeText*)CreateAnnot: (PTSDFDoc*)doc pos:  (PTPDFRect*)pos;
...
+ (PTLink*)CreateAnnot: (PTSDFDoc*)doc pos:  (PTPDFRect*)pos;
...
+ (PTPolyLine*)CreateAnnot: (PTSDFDoc*)doc pos:  (PTPDFRect*)pos;
- (int)GetVertexCount;
...
+ (PTPolygon*)CreateAnnot: (PTSDFDoc*)doc pos:  (PTPDFRect*)pos;
- (instancetype)initWithD: (PTObj*)d;- (instancetype)init;- (instancetype)initWithAnn: (PTAnnot*)ann;
@end
...
- (void)SetOverlayTextFont: (NSString *)font_name;
...
+ (PTRubberStamp*)CreateAnnot: (PTSDFDoc*)doc pos:  (PTPDFRect*)pos icon:  (PTRubberStampIcon)icon;
...
+ (PTScreen*)CreateAnnot: (PTSDFDoc*)doc pos:  (PTPDFRect*)pos;
- (NSString *)GetTitle;
- (void)SetTitle: (NSString *)title;
- (PTAction*)GetAction;
- (void)SetAction: (PTAction*)action;
...
+ (PTStrikeOut*)CreateAnnot: (PTSDFDoc*)doc pos:  (PTPDFRect*)pos;
- (instancetype)initWithD: (PTObj*)d;- (instancetype)initWithAnn: (PTAnnot*)ann;
@end
...
+ (PTText*)CreateAnnot: (PTSDFDoc*)doc pos:  (PTPDFRect*)pos contents:  (NSString *)contents;
...
+ (PTUnderline*)CreateAnnot: (PTSDFDoc*)doc pos:  (PTPDFRect*)pos;
- (instancetype)initWithD: (PTObj*)d;- (instancetype)initWithAnn: (PTAnnot*)ann;
@end
...
+ (PTWatermark*)CreateAnnot: (PTSDFDoc*)doc pos:  (PTPDFRect*)pos;
- (instancetype)initWithD: (PTObj*)d;- (instancetype)init;- (instancetype)initWithAnn: (PTAnnot*)ann;
@end
...
- (instancetype)initWithD: (PTObj*)d;- (instancetype)init;- (instancetype)initWithAnnot: (PTAnnot*)annot;
@end
...
- (instancetype)initWithField: (PTField*)field;- (instancetype)initWithGroup: (PTRadioButtonGroup*)group;- (instancetype)initWithImpl: (void *)impl;
@end
...
- (PTObj*)GetRBGroups;
- (void)SetRBGroups: (PTObj*)rbgroups_array;
- (PTObj*)GetSDFObj;
...
- (PTObj*)GetSDFObj;
- (instancetype)initWithOcg: (PTObj*)ocg;
@end
...
- (PTObj*)GetSDFObj;
- (instancetype)initWithOcmd: (PTObj*)ocmd;
@end
...
- (void)Destroy;
- (instancetype)initWithConvert: (BOOL)convert file_path:  (NSString *)file_path password:  (NSString *)password conf:  (PTConformance)conf exceptions:  (int)exceptions num_exceptions:  (int)num_exceptions max_ref_objs:  (int)max_ref_objs first_stop:  (BOOL)first_stop;- (instancetype)initWithConvert: (BOOL)convert file_path:  (NSString *)file_path password:  (NSString *)password conf:  (PTConformance)conf exceptions:  (int)exceptions num_exceptions:  (int)num_exceptions max_ref_objs:  (int)max_ref_objs;- (instancetype)initWithConvert: (BOOL)convert buf:  (NSData *)buf buf_size:  (unsigned long)buf_size password:  (NSString *)password conf:  (PTConformance)conf exceptions:  (int)exceptions num_exceptions:  (int)num_exceptions max_ref_objs:  (int)max_ref_objs first_stop:  (BOOL)first_stop;
@end
...
@interface PTPDFUAConformance : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)dealloc;
- (void)Destroy;
- (void)AutoConvert: (NSString *)src_file dest_file:  (NSString *)dest_file;
- (void)AutoConvertWithOptions: (NSString *)src_file dest_file:  (NSString *)dest_file options:  (PTPDFUAOptions*)options;
+ (PTPDFUAConformance*)CreateInternal: (unsigned long long)impl;
- (unsigned long long)GetHandleInternal;
- (instancetype)init;
@end


@interface PTPDFUAOptions : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (PTPDFUAConformanceLevel)GetConformanceLevel;
- (PTPDFUAOptions*)SetConformanceLevel: (PTPDFUAConformanceLevel)value;
- (NSString *)GetDefaultLangCode;
- (PTPDFUAOptions*)SetDefaultLangCode: (NSString *)value;
- (NSString *)GetFigureAltTextPrefix;
- (PTPDFUAOptions*)SetFigureAltTextPrefix: (NSString *)value;
- (BOOL)GetFirstStop;
- (PTPDFUAOptions*)SetFirstStop: (BOOL)value;
- (unsigned int)GetMaxRefObjs;
- (PTPDFUAOptions*)SetMaxRefObjs: (unsigned int)value;
- (NSString *)GetPassword;
- (PTPDFUAOptions*)SetPassword: (NSString *)value;
- (BOOL)GetSaveLinearized;
- (PTPDFUAOptions*)SetSaveLinearized: (BOOL)value;
- (instancetype)init;
@end
...
- (unsigned long long)GetHandleInternal;
- (instancetype)init;- (instancetype)initWithIn_bookmark_dict: (PTObj*)in_bookmark_dict;
@end
...
- (void)Destroy;
- (instancetype)initWithShading_dict: (PTObj*)shading_dict;
@end
...
- (void)Type3FontBegin: (PTCharData*)char_data resource_dict:  (PTObj*)resource_dict;
- (BOOL)End;
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (instancetype)initWithImage_element: (PTElement*)image_element;- (instancetype)initWithImage_xobject: (PTObj*)image_xobject;- (instancetype)initWithImage: (PTImage*)image;
@end
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
- (instancetype)initWithImage_element: (PTElement*)image_element premultiply:  (BOOL)premultiply;- (instancetype)initWithImage_element: (PTElement*)image_element;- (instancetype)initWithImage_xobject: (PTObj*)image_xobject premultiply:  (BOOL)premultiply;- (instancetype)initWithImage: (PTImage*)image premultiply:  (BOOL)premultiply;
@end
...
- (void)APIDataOfflineProc: (NSString *)api_data_json;
+ (void)StaticAPIDataOfflineProc: (NSString *)api_data_json user_data:  (void *)user_data;
...
- (int)GetLastPageNum;
- (PTObj*)GetSDFObj;
- (instancetype)initWithL: (PTObj*)l first_page:  (int)first_page last_page:  (int)last_page;
@end
...
- (void)Destroy;
- (instancetype)init;- (instancetype)initWithOne_page: (int)one_page;- (instancetype)initWithRange_start: (int)range_start range_end:  (int)range_end filter:  (PTPageSetFilter)filter;
@end
...
- (void)SetNightModeTuning: (double)contrast saturation:  (double)saturation flipness:  (double)flipness;
...
- (BOOL)GetUseNonStandardRotation;
- (PTMergeXFDFOptions*)SetUseNonStandardRotation: (BOOL)value;
- (instancetype)init;
@end
...
- (int)AppendTextDiff: (PTPage*)page1 page2:  (PTPage*)page2;
...
- (unsigned long long)GetHandleInternal;
- (instancetype)init;- (instancetype)initWithSdfdoc: (PTSDFDoc*)sdfdoc;- (instancetype)initWithFilepath: (NSString *)filepath;- (instancetype)initWithStream: (PTFilter*)stream;- (instancetype)initWithBuf: (NSData*)buf buf_size:  (unsigned long)buf_size;
@end
...
- (PTOfficeToPDFOptions*)SetAnimationHandling: (AnimationMode)value;
- (BOOL)GetApplyPageBreaksToSheet;
- (PTOfficeToPDFOptions*)SetApplyPageBreaksToSheet: (BOOL)value;
- (double)GetDefaultMarginBottom;
- (PTOfficeToPDFOptions*)SetDefaultMarginBottom: (double)value;
- (double)GetDefaultMarginLeft;
- (PTOfficeToPDFOptions*)SetDefaultMarginLeft: (double)value;
- (double)GetDefaultMarginRight;
- (PTOfficeToPDFOptions*)SetDefaultMarginRight: (double)value;
- (double)GetDefaultMarginTop;
- (PTOfficeToPDFOptions*)SetDefaultMarginTop: (double)value;
- (double)GetDefaultPageHeight;
- (PTOfficeToPDFOptions*)SetDefaultPageHeight: (double)value;
- (double)GetDefaultPageWidth;
- (PTOfficeToPDFOptions*)SetDefaultPageWidth: (double)value;
- (BOOL)GetDisableExcelHeadersFooters;
- (PTOfficeToPDFOptions*)SetDisableExcelHeadersFooters: (BOOL)value;
- (BOOL)GetDisableExcelMargins;
- (PTOfficeToPDFOptions*)SetDisableExcelMargins: (BOOL)value;
- (BOOL)GetDisableSheetHeightLimit;
- (PTOfficeToPDFOptions*)SetDisableSheetHeightLimit: (BOOL)value;
- (BOOL)GetDisplayChangeTracking;
- (PTOfficeToPDFOptions*)SetDisplayChangeTracking: (BOOL)value;
- (PTOfficeToPDFDisplayComments)GetDisplayComments;
- (PTOfficeToPDFOptions*)SetDisplayComments: (PTOfficeToPDFDisplayComments)value;
- (BOOL)GetDisplayHiddenCells;
- (PTOfficeToPDFOptions*)SetDisplayHiddenCells: (BOOL)value;
- (BOOL)GetDisplayHiddenText;
- (PTOfficeToPDFOptions*)SetDisplayHiddenText: (BOOL)value;
- (DisplaySpeakerNotes)GetDisplaySpeakerNotes;
- (PTOfficeToPDFOptions*)SetDisplaySpeakerNotes: (DisplaySpeakerNotes)value;
...
- (PTOfficeToPDFOptions*)SetShowExcelGridlines: (BOOL)value;
- (PTOfficeToPDFStructureTagLevel)GetStructureTagLevel;
- (PTOfficeToPDFOptions*)SetStructureTagLevel: (PTOfficeToPDFStructureTagLevel)value;
...
- (PTOfficeToPDFOptions*)SetUpdateDynamicFields: (UpdateDynamicFields)value;
...
- (void)FillTemplateJsonToOfficeWithFilter: (NSString *)json output_stream:  (PTFilter*)output_stream;
...
+ (void)FromXpsWithBuffer: (PTPDFDoc*)in_pdfdoc buf:  (NSData *)buf buf_sz:  (unsigned long)buf_sz;
...
+ (void)ToTiffWithPDFDoc: (PTPDFDoc*)in_pdfdoc out_path:  (NSString *)out_path options:  (PTTiffOutputOptions*)options;
...
@interface PTConvert (OfficeConversion)

/**
 * Converts an HTML string to PDF using a WKWebView. This method must be called from the main thread.
 *
 * @param htmlString The string containing valid HTML.
 *
 * @param baseURL The base URL for the content.
 *
 * @param paperSize The size of the paper in units of PDF Points. Passing CGSizeZero will default to letter size, portrait orientation (612.0, 792.0)
 *
 * @param completion A block that is executed when the
 * conversion is complete. The paramater pathToPDF will point
 * to the newly converted PDF. The PDF will be deleted after
 * the execution of the completion block, so it should be
 * copied if required beyond the completion block.
 */
+ (void)convertHTMLStringToPDF:(NSString *)htmlString baseURL:(NSURL *)baseURL paperSize:(CGSize)paperSize completion:(void(^)(NSString *pathToPDF))completion;
 ...
 *
 * @param filePath The path of the source document
 *
 * @param paperSize The size of the paper in units of PDF Points. Passing CGSizeZero will default to letter size, portrait orientation (612.0, 792.0)
 *
 * @param completion A block that is executed when the
 ...
 * copied if required beyond the completion block.
 */
+ (void)convertOfficeToPDF:(NSString *)filePath paperSize:(CGSize)paperSize completion:(void(^)(NSString *pathToPDF))completion;
 ...
 * copied if required beyond the completion block.
 */
+ (void)convertOfficeToPDFWithURL:(NSURL *)url paperSize:(CGSize)paperSize completion:(void(^)(NSString *pathToPDF))completion;
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
+ (NSString *)LanguageChoiceToString: (PTLanguageChoice)language;
+ (NSString *)PreferredOCRChoiceToString: (PTPreferredOCREngine)engine;
- (instancetype)init;
@end


@interface PTStructuredOutputOptions : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
+ (PTSectionConversionSetting)SectionConversionSettingFromOption: (SWIGTYPE_p_p_TRN_obj_*)obj;
- (instancetype)init;
@end
...
- (void)SetHeadersAndFootersSetting: (PTSectionConversionSetting)option;
- (void)SetFootnotesSetting: (PTSectionConversionSetting)option;
- (PTSectionConversionSetting)GetHeadersAndFootersSetting;
- (PTSectionConversionSetting)GetFootnotesSetting;
- (void)SetTextRecoveryNSE: (BOOL)use_ocr;
- (void)SetCustomOptionWithString: (NSString *)opt_name opt_value:  (NSString *)opt_value;
- (void)SetCustomOptionWithInt: (NSString *)opt_name opt_value:  (int)opt_value;
- (instancetype)init;
@end
...
- (void)SetPreferredOCREngine: (PTPreferredOCREngine)engine;
- (void)SetCustomOCRLanguage: (NSString *)ocrlang;
- (void)SetSearchableImageSetting: (PTPowerPointSearchableImageSetting)setting;
- (void)SetTextRecoveryNSE: (BOOL)use_ocr;
- (void)SetCustomOptionWithString: (NSString *)opt_name opt_value:  (NSString *)opt_value;
- (void)SetCustomOptionWithInt: (NSString *)opt_name opt_value:  (int)opt_value;
- (void)SetHeadersAndFootersSetting: (PTSectionConversionSetting)option;
...
@interface PTBarcodeModule : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)dealloc;
+ (BOOL)IsModuleAvailable;
+ (void)ExtractBarcodes: (PTPDFDoc*)src output_file_path:  (NSString *)output_file_path options:  (PTBarcodeOptions*)options;
+ (NSString *)ExtractBarcodesAsString: (PTPDFDoc*)src options:  (PTBarcodeOptions*)options;
- (instancetype)init;
@end


@interface PTHandwritingICRModule : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)dealloc;
+ (BOOL)IsModuleAvailable;
+ (NSString *)GetICRJsonFromPDF: (PTPDFDoc*)src options:  (PTHandwritingICROptions*)options;
+ (void)ApplyICRJsonToPDF: (PTPDFDoc*)dst json:  (NSString *)json;
+ (void)ProcessPDF: (PTPDFDoc*)dst options:  (PTHandwritingICROptions*)options;
- (instancetype)init;
@end


@interface PTTransPDFOptions : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (PTTransPDFOptions*)SetBatchSize: (unsigned int)value;
- (NSString *)GetPages;
- (PTTransPDFOptions*)SetPages: (NSString *)value;
- (BOOL)GetResizeSingleLine;
- (PTTransPDFOptions*)SetResizeSingleLine: (BOOL)value;
- (BOOL)GetFlipPageContentsForBiDirectionalTranslations;
- (PTTransPDFOptions*)SetFlipPageContentsForBiDirectionalTranslations: (BOOL)value;
- (NSString *)GetSourceLanguage;
- (PTTransPDFOptions*)SetSourceLanguage: (NSString *)value;
- (PTXLIFFVersion)GetXLIFFVersion;
- (PTTransPDFOptions*)SetXLIFFVersion: (PTXLIFFVersion)value;
- (instancetype)init;
@end


@interface PTTransPDF : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
+ (void)ExtractXLIFFWithFilter: (PTPDFDoc*)input_output_pdf output_stream_for_xliff:  (PTFilter*)output_stream_for_xliff options:  (PTTransPDFOptions*)options;
+ (void)ApplyXLIFFWithFilter: (PTPDFDoc*)input incoming_xliff:  (PTFilter*)incoming_xliff options:  (PTTransPDFOptions*)options;
+ (void)ExtractXLIFF: (PTPDFDoc*)input_output_pdf output_xliff:  (NSString *)output_xliff options:  (PTTransPDFOptions*)options;
+ (void)ApplyXLIFF: (PTPDFDoc*)input incoming_xliff:  (NSString *)incoming_xliff options:  (PTTransPDFOptions*)options;
- (instancetype)init;
@end


@interface PTFindReplaceOptions : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (PTFindReplaceOptions*)SetAlignment: (HorizAlignment)value;
- (unsigned int)GetBatchSize;
- (PTFindReplaceOptions*)SetBatchSize: (unsigned int)value;
- (BOOL)GetMatchCase;
- (PTFindReplaceOptions*)SetMatchCase: (BOOL)value;
- (MatchType)GetMatchMode;
- (PTFindReplaceOptions*)SetMatchMode: (MatchType)value;
- (NSString *)GetPages;
- (PTFindReplaceOptions*)SetPages: (NSString *)value;
- (ReflowType)GetReflowMode;
- (PTFindReplaceOptions*)SetReflowMode: (ReflowType)value;
- (BOOL)GetWholeWords;
- (PTFindReplaceOptions*)SetWholeWords: (BOOL)value;
- (instancetype)init;
@end


@interface PTFindReplace : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
+ (void)FindReplaceText: (PTPDFDoc*)input_output_pdf from:  (NSString *)from to:  (NSString *)to options:  (PTFindReplaceOptions*)options;
- (instancetype)init;
@end


@interface PTContentEdit : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
+ (void)Begin: (PTPDFDoc*)input_pdf;
+ (NSString *)RunXML: (NSString *)commands_xml;
+ (void)End;
- (instancetype)init;
@end


@interface PTSanitizeOptions : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)dealloc;
- (BOOL)GetActions;
- (PTSanitizeOptions*)SetActions: (BOOL)value;
- (BOOL)GetBookmarks;
- (PTSanitizeOptions*)SetBookmarks: (BOOL)value;
- (BOOL)GetEmbeddedContent;
- (PTSanitizeOptions*)SetEmbeddedContent: (BOOL)value;
- (BOOL)GetFormData;
- (PTSanitizeOptions*)SetFormData: (BOOL)value;
- (BOOL)GetHiddenLayers;
- (PTSanitizeOptions*)SetHiddenLayers: (BOOL)value;
- (BOOL)GetHiddenText;
- (PTSanitizeOptions*)SetHiddenText: (BOOL)value;
- (BOOL)GetMarkups;
- (PTSanitizeOptions*)SetMarkups: (BOOL)value;
- (BOOL)GetMetadata;
- (PTSanitizeOptions*)SetMetadata: (BOOL)value;
- (BOOL)GetOccludedText;
- (PTSanitizeOptions*)SetOccludedText: (BOOL)value;
- (BOOL)GetSearchIndices;
- (PTSanitizeOptions*)SetSearchIndices: (BOOL)value;
- (instancetype)init;
@end


@interface PTSanitizer : NSObject
{
	void *swigCPtr;
	BOOL swigCMemOwn;
}
...
- (void)setSwigCMemOwn: (BOOL) own;
- (void)dealloc;
+ (PTSanitizeOptions*)GetSanitizableContent: (PTPDFDoc*)doc;
+ (void)SanitizeDocument: (PTPDFDoc*)doc options:  (PTSanitizeOptions*)options;
- (instancetype)init;
@end
...
+ (void)SetAPIDataOfflineProc: (PTCallback*)instance;
- (instancetype)init;
@end

@interface PTPDFNet (CatchException)
/**
 * A convenience method to translate Obj-C exceptions into Swift errors.
 * Usage example:
 * ```
 *      do {
...
- (void)Destroy;
- (instancetype)initWithSize_type: (PTSizeType)size_type a:  (double)a b:  (double)b;
@end
...
+ (void)Initialize;
+ (BOOL)IsInitialized;
+ (void)GetReflow: (PTPage*)page proc:  (PTJobRequestProcHandler)proc custom_data:  (void *)custom_data;
...
- (void)dealloc;
- (void)Destroy;
- (instancetype)initWithPage_num: (int)page_num bbox:  (PTPDFRect*)bbox negative:  (BOOL)negative text:  (NSString *)text;
@end
...
- (void)setEnableTextWrapping: (BOOL)value;
- (BOOL)getEnableTextWrapping;
