...
public:
	...
	enum ErrorCode
	{
		...
		e_PDFA1_12_7 =1127, ///< Real number's integer part has excessive absolute magnitude; it must be 32767.0 or less
		e_PDFA1_12_11 =11211, ///< Maximum length of a string in bytes (65535) exceeded
		e_PDFA1_12_13 =11213, ///< Maximum number of DeviceN components (8) exceeded
		e_PDFA1_12_15 =11215, ///< Maximum value (65535) of a CID (character identifier) exceeded
		...
		e_PDFA3_2_2  =322,  ///< A Font dictionary has missing or invalid Type entry
		e_PDFA3_2_3  =323,  ///< A Font dictionary has missing or invalid Subtype entry
		e_PDFA3_2_4  =324,  ///< A BaseFont entry is missing or has invalid type
		e_PDFA3_2_5  =325,  ///< A non-standard simple font dictionary has missing or invalid FirstChar entry
		e_PDFA3_2_6  =326,  ///< A non-standard simple font dictionary has missing or invalid LastChar entry
		e_PDFA3_2_7  =327,  ///< Widths array is missing or has invalid size
		...
		e_PDFA3_4_1  =341,  ///< The font program is not embedded
		...
		e_PDFA3_5_7  =357,  ///< Embedded Type1 font descriptor's CharSet string does not list all glyphs.
		...
		e_PDFA4_4    =44,   ///< Transparency used (Blend mode is not 'Normal' or 'Compatible').
		...
		e_PDFA7_5_1  =751,  ///< 'bytes' and 'encoding' attributes are not allowed in the header of an XMP packet.
		...
		e_PDFA9_5    =95,   ///< A Widget annotation does not have an appearance dictionary.
		...
		e_PDFA8_3_3_1=8331, ///< Missing StructTreeRoot
		...
		e_PDFA8_4_1  =841,  ///< Invalid format for Lang entry in document catalog or in a structure element dictionary


		// PDF/A-2 Level B Validation Errors --------------------------------
		e_PDFA1_2_3   =123,     ///< Bad file header.
		e_PDFA1_3_5   =135,     ///< The file trailer dictionary's ID values are empty.
		e_PDFA1_10_2  =1102,    ///< Invalid use of Crypt filter.
		e_PDFA1_10_3  =1103,    ///< Bad stream Filter.
		e_PDFA1_12_8  =1128,    ///< A conforming file shall not contain any real number closer to zero than +/- 1.175 x 10^-38.
		e_PDFA1_12_9  =1129,    ///< A conforming file shall not contain any real number outside the range of +/- 3.403 x 10^38.
		e_PDFA1_12_10 =11210,   ///< Bad Permission Dictionary
		e_PDFA1_12_12 =11212,   ///< A conforming file shall not contain any string longer than 32767 bytes.
		e_PDFA1_12_14 =11214,   ///< Maximum number of DeviceN colorants (32) exceeded
		...
		e_PDFA2_4_2_10 =24210,  ///< OPM is 1
		e_PDFA2_4_2_11 =24211,  ///< Incorrect colorant specification in DeviceN
		e_PDFA2_4_2_12 =24212,  ///< tintTransform is different in Separations with the same colorant name.
		e_PDFA2_4_2_13 =24213,  ///< alternateSpace is different in Separations with the same colorant name.
		...
		e_PDFA3_3_4    =334,    ///< Annotation which has non-zero width and height and is not a popup or link does not have an appearance dictionary (AP key).
		e_PDFA5_2_12   =5212,   ///< A Page dictionary has an AA key.
		...
		e_PDFA6_2_11_5 =62115,  ///< Some characters map to 0, FEFF or FFFE.
		...
		e_PDFA6_2_11_3_3 =621133, ///< A CMap references another non-standard CMap.
		...
		e_PDFA_4_6_6_3_1   = 46631,      ///< A document catalog or a page dictionary contains an AA entry and its value contains key(s) not from the following list: E, X, D, U, Fo	 and Bl.
		...
		e_PDFA_4_6_3_1_6   = 46316,      ///< RichMedia annotation type is not permitted.
		...
		e_PDFA_4_6_2_10_8_1  = 4621081,  ///< The ActualText entry shall not contain any PUA values.
