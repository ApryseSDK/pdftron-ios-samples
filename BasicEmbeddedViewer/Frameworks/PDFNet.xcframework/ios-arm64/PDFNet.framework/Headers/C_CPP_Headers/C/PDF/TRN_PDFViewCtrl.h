...
TRN_API TRN_PDFViewCtrlSetRightToLeftLanguage(TRN_PDFViewCtrl view, TRN_Bool enabled);
TRN_API TRN_PDFViewCtrlGetRightToLeftLanguage(TRN_PDFViewCtrl view, TRN_Bool* result);
...
TRN_API TRN_PDFViewCtrlUpdateCustomHeaders(TRN_PDFViewCtrl view, TRN_Obj headers);
