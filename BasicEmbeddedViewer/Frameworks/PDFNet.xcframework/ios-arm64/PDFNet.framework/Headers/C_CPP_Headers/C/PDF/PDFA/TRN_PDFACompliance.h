...
enum TRN_PDFAComplianceConformance {
	...
	e_PDFACompliance_Level4,
	e_PDFACompliance_Level4E,
	e_PDFACompliance_Level4F
};
...
enum TRN_PDFAComplianceErrorCode
{
	...
	e_PDFACompliance_PDFA1_8_7  =187,  ///< Invalid UTF8 string
	...
	e_PDFACompliance_PDFA1_12_7 =1127, ///< Real number's integer part has excessive absolute magnitude; it must be 32767.0 or less
	e_PDFACompliance_PDFA1_12_11 =11211, ///< Maximum length of a string in bytes (65535) exceeded
	e_PDFACompliance_PDFA1_12_13 =11213, ///< Maximum number of DeviceN components (8) exceeded
	e_PDFACompliance_PDFA1_12_15 =11215, ///< Maximum value (65535) of a CID (character identifier) exceeded
	...
	e_PDFACompliance_PDFA3_2_2  =322,  ///< A Font dictionary has missing or invalid Type entry
	e_PDFACompliance_PDFA3_2_3  =323,  ///< A Font dictionary has missing or invalid Subtype entry
	e_PDFACompliance_PDFA3_2_4  =324,  ///< A BaseFont entry is missing or has invalid type
	e_PDFACompliance_PDFA3_2_5  =325,  ///< A non-standard simple font dictionary has missing or invalid FirstChar entry
	e_PDFACompliance_PDFA3_2_6  =326,  ///< A non-standard simple font dictionary has missing or invalid LastChar entry
	e_PDFACompliance_PDFA3_2_7  =327,  ///< Widths array is missing or has invalid size
	...
	e_PDFACompliance_PDFA3_4_1  =341,  ///< The font program is not embedded
	...
	e_PDFACompliance_PDFA3_5_7  =357,  ///< Embedded Type1 font descriptor's CharSet string does not list all glyphs.
	...
	e_PDFACompliance_PDFA4_4    =44,   ///< Transparency used (Blend mode is not 'Normal' or 'Compatible').
	...
	e_PDFACompliance_PDFA7_5_1  =751,  ///< 'bytes' and 'encoding' attributes are not allowed in the header of an XMP packet.
	...
	e_PDFACompliance_PDFA9_5    =95,   ///< A Widget annotation does not have an appearance dictionary.
	...
	e_PDFACompliance_PDFA8_3_3_1=8331, ///< Missing StructTreeRoot
	...
	e_PDFACompliance_PDFA8_4_1  =841,  ///< Invalid format for Lang entry in document catalog or in a structure element dictionary


	// PDF/A-2 Level B Validation Errors --------------------------------
	e_PDFACompliance_PDFA1_2_3   =123,     ///< Bad file header.
	e_PDFACompliance_PDFA1_3_5   =135,     ///< The file trailer dictionary's ID values are empty.
	e_PDFACompliance_PDFA1_10_2  =1102,    ///< Invalid use of Crypt filter.
	e_PDFACompliance_PDFA1_10_3  =1103,    ///< Bad stream Filter.
	e_PDFACompliance_PDFA1_12_8  =1128,    ///< A conforming file shall not contain any real number closer to zero than +/- 1.175 x 10^-38.
	e_PDFACompliance_PDFA1_12_9  =1129,    ///< A conforming file shall not contain any real number outside the range of +/- 3.403 x 10^38.
	e_PDFACompliance_PDFA1_12_10 =11210,   ///< Bad Permission Dictionary
	e_PDFACompliance_PDFA1_12_12 =11212,   ///< A conforming file shall not contain any string longer than 32767 bytes.
	e_PDFACompliance_PDFA1_12_14 =11214,   ///< Maximum number of DeviceN colorants (32) exceeded
	...
	e_PDFACompliance_PDFA2_4_2_10 =24210,  ///< OPM is 1
	e_PDFACompliance_PDFA2_4_2_11 =24211,  ///< Incorrect colorant specification in DeviceN
	e_PDFACompliance_PDFA2_4_2_12 =24212,  ///< tintTransform is different in Separations with the same colorant name.
	e_PDFACompliance_PDFA2_4_2_13 =24213,  ///< alternateSpace is different in Separations with the same colorant name.
	...
	e_PDFACompliance_PDFA3_3_4    =334,    ///< Annotation which has non-zero width and height and is not a popup or link does not have an appearance dictionary (AP key).
	e_PDFACompliance_PDFA5_2_12   =5212,   ///< A Page dictionary has an AA key.
	...
	e_PDFACompliance_PDFA6_10_0   =6100,   ///< PresSteps is not allowed
	e_PDFACompliance_PDFA6_10_1   =6101,   ///< AlternatePresentations not allowed
	e_PDFACompliance_PDFA6_2_11_5 =62115,  ///< Some characters map to 0, FEFF or FFFE.
	e_PDFACompliance_PDFA6_2_11_6 =62116,  ///< Some text can't be mapped to Unicode
	e_PDFACompliance_PDFA6_2_11_7 =62117,  ///< PUA characters are missing ActualText
	e_PDFACompliance_PDFA6_2_11_8 =62118,  ///< Use of .notdef glyph
	e_PDFACompliance_PDFA6_2_11_3_3 =621133, ///< A CMap references another non-standard CMap.
	e_PDFACompliance_PDFA6_9_1    =69001,  ///< Optional content Missing Name entry
	e_PDFACompliance_PDFA6_9_3    =69003,  ///< Optional content Contains AS entry

	// PDF/A-3 Validation Errors --------------------------------------
	e_PDFACompliance_PDFA_3E1     =1,      ///< Embedded file has no MIME type entry
	e_PDFACompliance_PDFA_3E1_1   =101,    ///< Embedded file Params has no ModDate entry
	...
	// PDF/A-4 Validation Errors --------------------------------------
	//// An enum for PDF/A-4 starts with e_PDFA_4, and ends with the veraPDF rule number.
	//// For example, e_PDFA_4_6_1_3_4 is for PDF/A-4 Rule 6.1.3-4.
	e_PDFACompliance_PDFA_4_6_1_3_4   = 46134,      ///< The Info key shall not be present in the trailer dictionary unless there exists a PieceInfo entry in the document catalog dictionary.
	e_PDFACompliance_PDFA_4_6_1_3_5   = 46135,      ///< If a document information dictionary is present, it shall only contain a ModDate entry.
	e_PDFACompliance_PDFA_4_6_1_6_1_3 = 461613,     ///< 3D stream shall have a Subtype entry with a value which is either U3D or PRC.
	e_PDFACompliance_PDFA_4_6_7_3_5   = 46735,      ///< Invalid PDF/A revision.
	e_PDFACompliance_PDFA_4_6_2_5_3   = 46253,      ///< HTO entry in ExtGState.
	e_PDFACompliance_PDFA_4_6_6_3_1   = 46631,      ///< A document catalog or a page dictionary contains an AA entry and its value contains key(s) not from the following list: E, X, D, U, Fo	 and Bl.
	e_PDFACompliance_PDFA_4_6_1_12_1  = 461121,     ///< If the Version key is present in the document catalog dictionary, the first character in its value shall be a 2 (32h) and the second character of its value shall be a PERIOD (2Eh) (decimal point). The third character shall be a decimal digit. The number of characters of the value of the Version key shall be exactly 3.
	e_PDFACompliance_PDFA_4_6_2_4_2_3 = 462423,     ///< An ICCBased CMYK color space is identical to the current PDF/A OutputIntent color profile or the current transparency blending color space.
	e_PDFACompliance_PDFA_4_6_2_2_3   = 46223,      ///< A content stream's named resource not defined by a resource dictionary
	e_PDFACompliance_PDFA_4_6_3_1_6   = 46316,      ///< RichMedia annotation type is not permitted.
	e_PDFACompliance_PDFA_4_6_9_5     = 4695,       ///< Doc catalog is missing EmbeddedFiles key
	e_PDFACompliance_PDFA_4_6_2_10_6_1  = 4621061,  ///< For all non-symbolic TrueType fonts used for rendering, the embedded TrueType font program shall contain at least Microsoft Unicode (3,1 - Platform ID=3, Encoding ID=1), or Macintosh Roman (1,0 - Platform ID=1, Encoding ID=0) 'cmap' subtable that all necessary glyph lookups are able to be carried out
	e_PDFACompliance_PDFA_4_6_2_10_6_4  = 4621064,  ///< Symbolic TrueType fonts shall not contain an Encoding entry in the font dictionary, and the 'cmap' subtable in the embedded font program shall either contain the Microsoft Symbol (3,0 - Platform ID=3, Encoding ID=0) or the Mac Roman (1,0 - Platform ID=1, Encoding ID=0) encoding.
	e_PDFACompliance_PDFA_4_6_2_10_8_1  = 4621081,  ///< The ActualText entry shall not contain any PUA values.
...
TRN_API TRN_PDFAComplianceCreateFromFileWithOptions(TRN_Bool convert, const TRN_UString file_path, const TRN_OptionBase* in_options, TRN_PDFACompliance* result);
TRN_API TRN_PDFAComplianceCreateFromBufferWithOptions(TRN_Bool convert, const char* buf, int buf_size, const TRN_OptionBase* in_options, TRN_PDFACompliance* result);
