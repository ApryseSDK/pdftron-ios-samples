...
inline double DiffOptions::GetLuminosityCompression()
{
	SDF::Obj found = m_dict.FindObj("LuminosityCompression");
	if(found.IsValid())
	{
...
inline DiffOptions& DiffOptions::SetLuminosityCompression(double value)
{
	m_dict.PutNumber("LuminosityCompression", (value));
	return *this;
}
