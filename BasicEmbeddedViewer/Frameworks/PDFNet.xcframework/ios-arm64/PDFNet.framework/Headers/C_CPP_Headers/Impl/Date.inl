...
{
	REX(TRN_DateSetCurrentTime(this));
}

inline void Date::SetUT(char ut)
{
	REX(TRN_DateSetUT(this, ut));
}

inline void Date::SetUTHour(Int8 ut_hour)
{
	REX(TRN_DateSetUTHour(this, ut_hour));
}

inline void Date::SetUTMinutes(Int8 ut_minutes)
{
	REX(TRN_DateSetUTMinutes(this, ut_minutes));
}
...
inline char Date::GetMonth() { 
	return (char)TRN_DateGetMonth(this);
}

inline char Date::GetDay() { 
	return (char)TRN_DateGetDay(this);
}

inline char Date::GetHour() { 
	return (char)TRN_DateGetHour(this);
}

inline char Date::GetMinute() { 
	return (char)TRN_DateGetMinute(this);
}

inline char Date::GetSecond() { 
	return (char)TRN_DateGetSecond(this);
}

inline char Date::GetUT() { 
	return (char)TRN_DateGetUT(this);
}

inline char Date::GetUTHour() { 
	return (char)TRN_DateGetUTHour(this);
}

inline char Date::GetUTMin() { 
	return (char)TRN_DateGetUTMin(this);
}
#else // SWIG
