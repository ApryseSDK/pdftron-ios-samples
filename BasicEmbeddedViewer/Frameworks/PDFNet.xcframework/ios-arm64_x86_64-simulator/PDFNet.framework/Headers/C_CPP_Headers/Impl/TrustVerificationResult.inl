...
{
	REX(TRN_EmbeddedTimestampVerificationResultCopyCtor(other.m_impl, &m_impl));
}
...
{
	REX(TRN_EmbeddedTimestampVerificationResultAssign(other.m_impl, &m_impl));
	return *this;
}
...
{
	REX(TRN_EmbeddedTimestampVerificationResultDestroy(m_impl));
	m_impl = 0;
}
