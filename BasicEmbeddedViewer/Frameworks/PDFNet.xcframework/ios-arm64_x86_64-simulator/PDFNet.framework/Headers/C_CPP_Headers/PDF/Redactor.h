...
public:
	...
	/**
	 * Specifies whether text wrapping is enabled for overlay text.
	 * When true, text is wrapped across multiple lines at MaxFontSize to fit within the redaction area.
	 * When false, text is rendered on a single line, scaled between MinFontSize and MaxFontSize as needed.
	 */
