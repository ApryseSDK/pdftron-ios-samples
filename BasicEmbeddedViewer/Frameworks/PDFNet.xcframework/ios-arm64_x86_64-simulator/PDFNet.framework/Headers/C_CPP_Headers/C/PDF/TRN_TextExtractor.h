...
enum TRN_TextExtractorProcessingFlags
{
	...
	e_TextExtractor_no_watermarks = 128,
	e_TextExtractor_extract_using_zorder = 256
...
TRN_API TRN_TextExtractorGetHighlights(TRN_TextExtractor te, const int* char_ranges, size_t char_ranges_size, TRN_Highlights result);
