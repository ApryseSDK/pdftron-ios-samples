...
struct TRN_textrange;
typedef struct TRN_textrange* TRN_TextRange;
...
struct TRN_apRefChange
{
	TRN_UInt32 old_obj_num;
	TRN_UInt32 new_obj_num;
	TRN_UInt32 gen_num;
	TRN_Int32 page_num;
	TRN_Bool discard_appearance;
};
typedef struct TRN_apRefChange TRN_ApRefChange;
...
struct TRN_appearancestringlist;
typedef struct TRN_appearancestringlist* TRN_AppearanceStringList;
...
struct TRN_pdfaoptions;
typedef struct TRN_pdfaoptions* TRN_PDFAOptions;
...
struct TRN_TimestampingResult_tag;
typedef struct TRN_TimestampingResult_tag* TRN_TimestampingResult;
...
struct TRN_ContentElement_tag;
typedef struct TRN_ContentElement_tag* TRN_ContentElement;

typedef TRN_ContentElement TRN_ContentNode;
typedef TRN_ContentNode TRN_Paragraph;
typedef TRN_ContentElement TRN_TextRun;
typedef TRN_ContentElement TRN_TextStyledElement;
typedef TRN_ContentNode TRN_Table;
typedef TRN_ContentNode TRN_TableRow;
typedef TRN_ContentNode TRN_TableCell;

struct TRN_List_tag;
typedef struct TRN_List_tag* TRN_List;

struct TRN_ListItem_tag;
typedef struct TRN_ListItem_tag* TRN_ListItem;

struct TRN_AlgorithmParams_tag;
typedef struct TRN_AlgorithmParams_tag* TRN_AlgorithmParams;

typedef TRN_AlgorithmParams TRN_RSASSAPSSParams;

struct TRN_AlgorithmIdentifier_tag;
typedef struct TRN_AlgorithmIdentifier_tag* TRN_AlgorithmIdentifier;
